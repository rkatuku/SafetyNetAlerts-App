...
class TestMedicalRecordService {
	...
	void createPersonOkWithoutMedicalRecord() {
		...
		Person person2 = new Person("Jacob", "Boyd", "1509 Culver St", "Culver", "97451", "841-874-6513",
				"drk@email.com");
	...
	void createPersonErrorWithAlreadyMedicalRecordExisting() {
		...
		MedicalRecord newMedicalRecord = new MedicalRecord("John", "Boyd", BIRTHDAY_ADULT, medicationsList,
				allergiesList);
		MedicalRecord result = medicalRecordService.createMedicalRecord(newMedicalRecord);
	...
	void updatePersonErrorBecauseUnknownPerson() {
		...
		MedicalRecord medicalRecordUpdated = new MedicalRecord("Unknow", "Person", "01/01/1903", medicationsList,
				allergiesList);
	...
	void createPersonFailedBecausePersonIsNull() {
		...
		MedicalRecord newMedicalRecord = new MedicalRecord("Nicolas", "Gros", BIRTHDAY_ADULT, medicationsList,
				allergiesList);
		MedicalRecord result = medicalRecordService.createMedicalRecord(newMedicalRecord);
		assertThat(result).isNull();
	}
	...
	void updatePersonOkWithMedicalRecord() {
		...
		List<String> allergiesList = new ArrayList<>();
		allergiesList.add("AllergiesAdd");
		MedicalRecord medicalRecordUpdated = new MedicalRecord("John", "Boyd", "06/06/1066", medicationsList,
				allergiesList);
		boolean result = medicalRecordService.updateMedicalRecord(medicalRecordUpdated);
