...
public class TestFireStationController {
	...
	void existingFireStationAddAddressStatusIsCreated() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.post("/firestation").contentType(APPLICATION_JSON)
						.content("{\"address\": \"NEW ADDRESS\",\"station\": \"1\"}").accept(APPLICATION_JSON))
	...
	void AddAddressErrorAddressAlreadyExistFireStation4() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.post("/firestation").contentType(MediaType.APPLICATION_JSON_VALUE)
	...
	void AddAddressErrorAddressAlreadyExistFireStation3() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.post("/firestation").contentType(MediaType.APPLICATION_JSON_VALUE)
	...
	void AddAddressErrorAddressAlreadyExistFireStation2() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.post("/firestation").contentType(MediaType.APPLICATION_JSON_VALUE)
	...
	void AddAddressErrorAddressAlreadyExist() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.post("/firestation").contentType(MediaType.APPLICATION_JSON_VALUE)
	...
	void updateSuccessWithFireStation2AndCheckIsOk() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.put("/firestation").contentType(APPLICATION_JSON)
						.content("{\"address\": \"892 Downing Ct\",\"station\": \"2\"}").accept(APPLICATION_JSON))
	...
	void updateAddressErrorWithUnknownStationNumber() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.put("/firestation").contentType(APPLICATION_JSON) // APPLICATION_JSON_VALUE
				.content("{\"address\": \"Unknown address\",\"station\": \"1\"}")).andExpect(status().isNotFound());
	}
	...
	void deleteExistingAddressFireStationThenReturnOk() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.delete("/firestation").contentType(APPLICATION_JSON)
						.param("address", "951 LoneTree Rd").accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	}
	...
	void deleteNonExistingAddressError() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.delete("/firestation").contentType(APPLICATION_JSON)
						.param("address", "Saint Pierre de Soucy City").accept(MediaType.APPLICATION_JSON))
	...
	void givenUnknowStationNumber_whenRequest_thenReturnNotFound() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.get("/firestation").contentType(APPLICATION_JSON)
						.param("stationNumber", "499").accept(MediaType.APPLICATION_JSON))
				.andDo(MockMvcResultHandlers.print()).andExpect(status().isNotFound());
	}
	...
	void checkIfPhoneAlertOkWithCorrectStationNumber() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.get("/phoneAlert").contentType(APPLICATION_JSON).param("firestation",
						"1"))
	...
	public void checkErrorPhoneAlertWithUnknownStationNumber() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.get("/firestation").contentType(APPLICATION_JSON)
						.param("stationNumber", "20").accept(MediaType.APPLICATION_JSON))
				.andDo(MockMvcResultHandlers.print()).andExpect(status().isNotFound());
	}
	...
	void unknownAddressWhenFireReturnNotFoundError() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.get("/fire").contentType(APPLICATION_JSON).param("address", "INCONNU"))
	...
	void floodTwoValidStationEnteredAndReturnOk() throws Exception {
		this.mockMvc.perform(
				MockMvcRequestBuilders.get("/flood/stations").contentType(APPLICATION_JSON).param("stations", "2,3"))
				.andExpect(status().isOk());
	}
	...
	void floodUnknownStationAndReturnNotFoundError() throws Exception {
		this.mockMvc.perform(
				MockMvcRequestBuilders.get("/flood/stations").contentType(APPLICATION_JSON).param("stations", "33"))
